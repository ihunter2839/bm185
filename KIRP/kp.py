...
for j in range(0, len(gene_pos)):
    #position of the gene in the expression matrix
    pos = gene_pos[j]
    #expression vector for current gene 
    gene_exp = [exp_matrix[i][pos] for i in range(0,num_cols)]
    #combine gene expression and time of life data for each patient
